...
type Config struct {
	...
	// Windows DNS leak prevention (enabled by default when auto_route is true)
...
const file_proxy_tun_config_proto_rawDesc = "" +
	"\n" +
	"\x16proxy/tun/config.proto\x12\x0exray.proxy.tun\"\x81\x03\n" +
	"\x06Config\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03MTU\x18\x02 \x01(\rR\x03MTU\x12\x1d\n" +
	"\n" +
	"user_level\x18\x03 \x01(\rR\tuserLevel\x12\x1d\n" +
	"\n" +
	"auto_route\x18\x04 \x01(\bR\tautoRoute\x12#\n" +
	"\rroute_address\x18\x05 \x03(\tR\frouteAddress\x122\n" +
	"\x15route_exclude_address\x18\x06 \x03(\tR\x13routeExcludeAddress\x12!\n" +
	"\fstrict_route\x18\a \x01(\bR\vstrictRoute\x12\x1f\n" +
	"\vtable_index\x18\b \x01(\x05R\n" +
	"tableIndex\x12#\n" +
	"\rinet4_address\x18\t \x01(\tR\finet4Address\x12#\n" +
	"\rinet6_address\x18\n" +
	" \x01(\tR\finet6Address\x12,\n" +
	"\x12disable_dns_hijack\x18\v \x01(\bR\x10disableDnsHijackBL\n" +
